...
public class LogController {
   ...
   private static final Logger logger = LogManager.getLogger(LogController.class);
    ...
    public Log saveLog( @RequestBody CreateLog createLog) {
        logger.trace("hang tengah masukkan log");
        Log log = new Log();
        log.setFirstName(createLog.getFirstName());
        log.setLastName(createLog.getLastName());
        //log.setUpdatedAt(now);
        log.setCreatedAt(now);
        logger.trace("hang tengah masukkan pesakit"+createLog.getFirstName());
