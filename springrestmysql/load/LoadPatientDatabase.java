...
AB_POSITIVE, AB_NEGATIVE, O_POSITIVE, O_NEGATIVE
    ...
    CommandLineRunner loadDatabase (PatientService patientService) {
        ...
        return args -> {
            log.info("Preloading " + patientService.savePatient(new Patient("Ahmad", "Marzuki",new Date("11/08/1985"),"60125544123","marzuki@lapasar.com","no 16,persiaran surian..","60125544123",bloodTypeValue.AB_NEGATIVE,true)));
        };
